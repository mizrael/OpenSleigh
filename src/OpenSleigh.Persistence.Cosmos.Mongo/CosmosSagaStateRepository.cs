...
namespace OpenSleigh.Persistence.Cosmos.Mongo
{
    ...
    {
        public static readonly CosmosSagaStateRepositoryOptions Default = new CosmosSagaStateRepositoryOptions(TimeSpan.FromMinutes(1));
    }
    ...
    public class CosmosSagaStateRepository : ISagaStateRepository
    {
            ...
            where TD : SagaState
        {
            ...
            try
            {
                ...
                var state = _serializer.Deserialize<TD>(entity.Data);
