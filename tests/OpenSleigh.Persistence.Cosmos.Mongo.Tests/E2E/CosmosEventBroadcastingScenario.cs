...
{
    public class CosmosEventBroadcastingScenario : EventBroadcastingScenario, IClassFixture<DbFixture>
    {
        private readonly DbFixture _fixture;

        public CosmosEventBroadcastingScenario(DbFixture fixture)
        {
            _fixture = fixture;
        }
