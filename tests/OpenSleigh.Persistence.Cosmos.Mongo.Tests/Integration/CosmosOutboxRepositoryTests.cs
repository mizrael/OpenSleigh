...
namespace OpenSleigh.Persistence.Cosmos.Mongo.Tests.Integration
{
    ...
    public class CosmosOutboxRepositoryTests : IClassFixture<DbFixture>
    {
        private readonly DbFixture _fixture;

        public CosmosOutboxRepositoryTests(DbFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public async Task AppendAsync_should_fail_if_message_already_appended()
        {
            ...
            await Assert.ThrowsAsync<MongoDB.Driver.MongoWriteException> (async () => await sut.AppendAsync(new[] { message }));
        }
        ...
        private CosmosOutboxRepository CreateSut(IDbContext dbContext, CosmosOutboxRepositoryOptions options = null)
        {
            ...
            var sut = new CosmosOutboxRepository(dbContext, serializer, options, typeResolver);
            return sut;
        }
