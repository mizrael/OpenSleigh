...
{
    public class RabbitEventBroadcastingScenario : EventBroadcastingScenario, IClassFixture<RabbitFixture>
    {
        private readonly RabbitFixture _fixture;

        public RabbitEventBroadcastingScenario(RabbitFixture fixture)
        {
            _fixture = fixture;
        }
