...
{
    public class SQLKafkaSimpleSagaScenario : SimpleSagaScenario, 
        ...
        IAsyncLifetime
    {
        ...
        public SQLKafkaSimpleSagaScenario(KafkaFixture kafkaFixture, Persistence.SQL.Tests.Fixtures.DbFixture dbFixture)
        {
