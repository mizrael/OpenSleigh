...
{
    public class PostgreSQLEventBroadcastingScenario : EventBroadcastingScenario,
        ...
        IAsyncLifetime
    {
        ...
        public PostgreSQLEventBroadcastingScenario(DbFixture dbFixture, RabbitFixture rabbitFixture)
        {
