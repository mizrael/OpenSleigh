...
{
    public class PostgreSQLParentChildScenario : ParentChildScenario, 
        ...
        IAsyncLifetime
    {
        ...
        public PostgreSQLParentChildScenario(DbFixture dbFixture, RabbitFixture rabbitFixture)
        {
        ...
        protected override void ConfigureTransportAndPersistence(IBusConfigurator cfg)
        {
            ...
            cfg.UseRabbitMQTransport(_rabbitFixture.RabbitConfiguration, builder =>
            {
                ...
                builder.UseMessageNamingPolicy<ProcessParentSaga>(() =>
                    new QueueReferences(_topics[typeof(ProcessParentSaga)], _topics[typeof(ProcessParentSaga)], _topics[typeof(StartParentSaga)],
                ...
                builder.UseMessageNamingPolicy<StartChildSaga>(() =>
                    new QueueReferences(_topics[typeof(StartChildSaga)], _topics[typeof(StartChildSaga)], _topics[typeof(StartParentSaga)],
                                        _topics[typeof(StartChildSaga)] + ".dead", _topics[typeof(StartChildSaga)] + ".dead"));

                builder.UseMessageNamingPolicy<ProcessChildSaga>(() =>
                    new QueueReferences(_topics[typeof(ProcessChildSaga)], _topics[typeof(ProcessChildSaga)], _topics[typeof(StartParentSaga)],
