...
using OpenSleigh.Samples.ECommerce.PaymentService.Sagas;
using OpenSleigh.DependencyInjection;

namespace OpenSleigh.Samples.ECommerce.PaymentService;
            ...
            services.AddLogging(cfg =>
                ...
                .AddOpenSleigh(cfg =>
                {
                    ...
                    cfg.UseRabbitMQTransport(rabbitCfg)
                        ...
                        .AddSaga<CreditCheckSaga, CreditCheckSagaState>();
                });
        });
}
